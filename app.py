...
<div style="margin-top:1rem;font-size:.75rem;color:#8FB88A;">{res_sample_id}</div>
            ...
            fig_prob.update_layout(paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="#FFFFFF", margin=dict(l=10,r=10,t=10,b=10), height=200, dragmode=False, xaxis=dict(showgrid=False,tickfont=dict(size=11,color="#1A3B1A"),fixedrange=True), yaxis=dict(showgrid=True,gridcolor="#EAE3D8",tickfont=dict(size=10,color="#73786B"),range=[0,105],fixedrange=True), showlegend=False)
            st.plotly_chart(fig_prob, use_container_width=True, config={"displayModeBar": False, "scrollZoom": False, "doubleClick": False})
            ...
            fig_imp.update_layout(paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="#FFFFFF", margin=dict(l=10,r=10,t=10,b=10), height=290, dragmode=False, xaxis=dict(title="Decision Split Gain (%)", showgrid=True, gridcolor="#EAE3D8", fixedrange=True), yaxis=dict(tickfont=dict(size=10), fixedrange=True))
            st.plotly_chart(fig_imp, use_container_width=True, config={"displayModeBar": False, "scrollZoom": False, "doubleClick": False})
...
with tab_history:
    ...
    if df_hist.empty:
        ...
        with cc1:
            ...
            fig_d.update_layout(paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="rgba(0,0,0,0)", margin=dict(l=20,r=20,t=10,b=10), height=280, dragmode=False, showlegend=False)
            st.plotly_chart(fig_d, use_container_width=True, config={"displayModeBar": False, "scrollZoom": False, "doubleClick": False})
        with cc2:
            ...
            if n_col and p_col and k_col:
                ...
                fig_bh.update_layout(paper_bgcolor="rgba(0,0,0,0)", plot_bgcolor="#FFFFFF", margin=dict(l=20,r=20,t=10,b=10), height=280, dragmode=False, xaxis=dict(showgrid=False, fixedrange=True), yaxis=dict(showgrid=True,gridcolor="#EAE3D8", fixedrange=True), showlegend=False)
                st.plotly_chart(fig_bh, use_container_width=True, config={"displayModeBar": False, "scrollZoom": False, "doubleClick": False})
